                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 border rounded-md dark:bg-dark-bg-tertiary dark:border-dark-border dark:text-dark-text-primary ${errors.username ? 'border-red-500 dark:border-red-800' : 'border-gray-300 dark:border-dark-border'
                            }`}
                        />
                        {errors.username && (
        ...
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 animate-slide-up">
          ...
          >
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                <p
                  className={`text-sm font-medium ${toast.type === 'success' ? 'text-green-800 dark:text-green-300' : 'text-red-800 dark:text-red-300'
                    }`}
                >
                  {toast.message}
                </p>
